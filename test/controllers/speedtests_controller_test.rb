...
class SpeedtestsControllerTest < ActionController::TestCase
  ...
  test "should create speedtest" do
    assert_difference('Speedtest.count') do
      post :create, speedtest: { ip_address: @speedtest.ip_address, provider: @speedtest.provider, user_id: @speedtest.user_id, user_id: @speedtest.user_id }
    end
  ...
  test "should update speedtest" do
    patch :update, id: @speedtest, speedtest: { ip_address: @speedtest.ip_address, provider: @speedtest.provider, user_id: @speedtest.user_id, user_id: @speedtest.user_id }
    assert_redirected_to speedtest_path(assigns(:speedtest))
  end
